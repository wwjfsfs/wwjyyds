...
def main():
    ...
    # --------------------------------
    # testsets = 'DIV2K'
    testsets = '/home/lss/workspace/IMDN/data'
    ...
    # load model
    # --------------------------------
    model_path = os.path.join('/home/lss/workspace/IMDN/model_zoo', 'model_best.pt')
    model = MDAN(args)
    #print(model)
